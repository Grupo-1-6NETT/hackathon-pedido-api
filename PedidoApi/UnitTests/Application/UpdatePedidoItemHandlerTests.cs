...
public class UpdatePedidoItemHandlerTests
{
    private readonly Mock<IRabbitMqService> _rabbitMqServiceMock;
    private readonly Mock<IConfiguration> _configurationMock;
    private readonly UpdatePedidoItemHandler _sut;

    public UpdatePedidoItemHandlerTests()
    {
    ...
    public async Task Handle_InformadosDadosValidos_DeveRetornarOk()
    {
        ...
        _rabbitMqServiceMock.Verify(x => x.Publish(It.IsAny<UpdatePedidoItemDto>(), It.IsAny<string>()), Times.Once);
